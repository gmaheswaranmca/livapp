...
| 002 | 1071 | Greatest Common Divisor of Strings       | Find largest string that can repeatedly form both strings.                               | str1="ABCABC", str2="ABC"     | "ABC"                     | Check concatenation property and use GCD of lengths. |
| 003 | 1431 | Kids With the Greatest Number of Candies | Determine whether each child can have the maximum candies after receiving extra candies. | [2,3,5,1,3], extra=3          | [T,T,T,F,T]               | Find maximum candy count first.                      |
| 004 | 605  | Can Place Flowers                        | Determine if n flowers can be planted without adjacent flowers.                          | [1,0,0,0,1], n=1              | true                      | Greedy placement whenever possible.                  |
| 005 | 345  | Reverse Vowels of a String               | Reverse only vowels while keeping other characters fixed.                                | "hello"                       | "holle"                   | Two pointers from both ends.                         |
| 006 | 151  | Reverse Words in a String                | Reverse order of words in a sentence.                                                    | "the sky is blue"             | "blue is sky the"         | Split, reverse, join.                                |
| 007 | 238  | Product of Array Except Self             | Return product of all elements except current index.                                     | [1,2,3,4]                     | [24,12,8,6]               | Prefix and suffix products.                          |
| 008 | 334  | Increasing Triplet Subsequence           | Determine whether increasing subsequence of length 3 exists.                             | [1,2,3,4,5]                   | true                      | Track smallest and second smallest values.           |
| 009 | 443  | String Compression                       | Compress repeated characters in-place.                                                   | ["a","a","b","b","c","c","c"] | ["a","2","b","2","c","3"] | Two pointers and count frequencies.                  |
